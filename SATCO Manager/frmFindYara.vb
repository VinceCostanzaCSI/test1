Public Class frmFindYara
    ...
    Private Sub frmFindYara_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Dim LoopCtr As Integer
        Dim TmpStr As String

        Yara = New clsYara
        CenterForm(Me)
        TmpStr = Yara.SearchField
        For LoopCtr = 0 To 3
    ...
    Private Sub cmdFind_Click(sender As System.Object, e As System.EventArgs) Handles cmdFind.Click
        Yara.SearchData = txtSearchStr.Text
        Yara = Nothing
        Me.Close()
    End Sub
End Class