...
Public Class clsTransaction
    ...
    Public Function AddRecord()
        Try
            ...
            Dim strInsert As String = "INSERT INTO Trans (Code, Id, TDate, DriverId, VehicleId, TrailerId, ScaleNumber, TankId, CommodityId, TargetFillWt," &
                                       " GrossWt, TareWt, NetWt, ReleaseNumber, PO, ScaleTicket, InTime, OutTime, TankLevel, Analysis, Desc2, Desc3, Desc4, Desc5, Seal1, Seal2, Seal3, Seal4, Adjustment) VALUES (" &
                                         "'" & sCode & "'," &
                                         "'" & lId & "'," &
                                         "'" & dTDate & "'," &
                                         "'" & sDriverId & "'," &
    ...
    Public Property ScaleTicket() As String
        Get
            ScaleTicket = sScaleTicket
        End Get
        Set(value As String)
