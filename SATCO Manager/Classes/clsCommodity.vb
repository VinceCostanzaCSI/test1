...
Public Class clsCommodity
    ...
    Public Function AddRecord(CurrentId As String)
        ...
        Try
            sId = CurrentId
            Dim strInsert As String = "INSERT INTO Commodity (Id, Description1, Description2, Description3, Description4, Description5, VariableWt, CType, Active) " & _
                                         "VALUES (" & _
                                         "'" & sId & "'," & _
                                         "'" & sDescription1 & "'," & _
                                         "'" & sDescription1 & "'," & _
