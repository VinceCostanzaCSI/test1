Public Class frmFindTank
    ...
    Private Sub frmFindBrenntag_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Dim LoopCtr As Integer
        Dim TmpStr As String

        Brenntag = New clsBrenntag
        CenterForm(Me)
        TmpStr = Brenntag.SearchField
        For LoopCtr = 0 To 3
    ...
    Private Sub cmdFind_Click(sender As System.Object, e As System.EventArgs) Handles cmdFind.Click
        Brenntag.SearchData = txtSearchStr.Text
        Brenntag = Nothing
        Me.Close()
    End Sub
End Class