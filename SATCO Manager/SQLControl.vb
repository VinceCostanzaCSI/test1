...
Public Class SQLControl
    ...
    Public Function HasConnection() As Boolean
        ...
        'ConnectionString = "Server=" & Environment.MachineName & ";Database=SATCO;User=adminuser;Pwd=Tampa08;"
        ConnectionString = "Server=" & DBPath & ";Database=SATCO;User=adminuser;Pwd=Tampa08;"
        Using SqlConnection = New SqlConnection(ConnectionString)
            ...
            Catch ex As Exception
                AddLogEntry("HasConnection: " & ex.Message)
                Return False
            End Try
        End Using
    End Function

    'Public Function HasConnection2() As Boolean
    '    Dim ConnectionString As String
    '    Dim SQLCon As SqlConnection
    '    'ConnectionString = "Server=" & Environment.MachineName & ";Database=SATCO;User=adminuser;Pwd=Tampa08;"
    '    ConnectionString = "Server=" & DBPath & ";Database=SATCO;User=adminuser;Pwd=Tampa08;"
