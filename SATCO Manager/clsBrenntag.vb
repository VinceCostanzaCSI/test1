...
Public Class clsBrenntag
    ...
    Public Sub UpdateRecord(CurrentId As String)
        ...
        Try
            Dim UpdateCmd As String = "UPDATE Brenntag " & _
                                      ...
                                      "AltCode ='" & sAltCode & "' , " & _
                                      "Name ='" & sName & "' , " & _
                                      "Address1 ='" & sAddress1 & "' , " & _
                                      "Address2 ='" & sAddress2 & "' , " & _
                                      "CSZ ='" & sCSZ & "' , " & _
                                      "MaxLoad ='" & sMaxLoad & "' , " & _
                                      "Notes ='" & sNotes & "' , " & _
                                      "Active ='" & bActive & "' " & _
    ...
    Public Function AddRecord(CurentId As String)
        Try
            sRelease = CurentId
            Dim strInsert As String = "INSERT INTO Brenntag (Release, PO, BOL, AltPO, AltCode, Name, Address1, Address2, CSZ, MaxLoad, Notes, Active) " & _
                                         "VALUES (" & _
                                         "'" & sRelease & "'," & _
                                         "'" & sPO & "'," & _
                                         "'" & sBOL & "'," & _
