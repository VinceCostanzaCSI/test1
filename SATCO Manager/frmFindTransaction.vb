Public Class frmFindTransaction
    ...
    Private Sub frmFindTransaction_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Dim LoopCtr As Integer
        Dim TmpStr As String

        Transaction = New clsTransaction
        CenterForm(Me)
        TmpStr = Transaction.SearchField
        For LoopCtr = 0 To 3
    ...
    Private Sub cmdFind_Click(sender As System.Object, e As System.EventArgs) Handles cmdFind.Click
        Transaction.SearchData = txtSearchStr.Text
        Transaction = Nothing
        Me.Close()
    End Sub
End Class