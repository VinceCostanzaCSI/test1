Public Class frmFindCommodity
    ...
    Private Sub frmFindCommodity_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Dim LoopCtr As Integer
        Dim TmpStr As String

        Commodity = New clsCommodity
        CenterForm(Me)
        TmpStr = Commodity.SearchField
        For LoopCtr = 0 To 3
    ...
    Private Sub cmdFind_Click(sender As System.Object, e As System.EventArgs) Handles cmdFind.Click
        Commodity.SearchData = txtSearchStr.Text
        Commodity = Nothing
        Me.Close()
    End Sub
End Class